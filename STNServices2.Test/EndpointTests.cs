...
namespace STNServices2.Test
{
    ...
    public class EndpointTests:EndpointTestBase
    {
        ...
        //[TestMethod]
        //public void ApproveHWMRequest()
        //{
        //    List<Int32> hwmIds = new List<Int32>(new Int32[] {14143,14144,14146,14148,14149,14152,14153,14155,14157,14158,14161,14162,14212,14214,14215,14217,14218,14220,14222,14223,14225,
        //        14226,14229,14230,14232,14233,14295,14299,14303,14304,14307,14308,14310,14311,14313,14314,14316,14317,14318,14319,14320,14321,14322,14323,14324,14325,14326,14327,14328,14330,
        //        14331,14332,14333,14334,14335,14336,14337,14338,14339,14340,14342,14343,14344,14346,14354,14355,14356,14365,14364,14366,14367,14370,14371,14372,14373,14383,14389,14402,14403,
        //        14404,14405,14406,14407,14408,14409,14410,14411,14412,14413,14414,14415,14417,14419,14420,14425,14428,14429,14432,14433,14434,14435,14447,14448,14450,14457,14458,14459,14460,
        //        14461,14464,14465,14466,14467,14468,14469,14470,14473,14494,14495,14512,14513,14514,14515,14516,14518,14519,14520,14521,14522,14523,14524,14525,14528,14529,14530,14531,14534,
        //        14545,14556,14557,14558,14559,14560,14561,14562,14563,14564,14565,14570,14571,14572,14573,14574,14575,14576,14577,14578});

        //    foreach (Int32 i in hwmIds)
        //    {
        //        //get the hwm
        //        hwm aHwm = this.GETRequest<hwm>(host + Configuration.hwmResource + "/" + i);
        //        Assert.IsNotNull(aHwm, "ID: " + aHwm.hwm_id.ToString());

        //        if (!aHwm.approval_id.HasValue)
        //        {
        //            //approve it
        //            approval approveHWM;
        //            approveHWM = this.POSTRequest<approval>(host + Configuration.hwmResource + "/" + aHwm.hwm_id + "/Approve", null, basicAuth);
        //            Assert.IsNotNull(approveHWM, "ID: " + approveHWM.approval_id.ToString());
        //        }
        //    }
