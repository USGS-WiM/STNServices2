    ...
    public class Configuration : IConfigurationSource
    {
        ...
        private void AddDATA_FILE_Resources()
        {
           ...
           .And.TranscodedBy<CsvDotNetCodec1>(null).ForMediaType("text/csv").ForExtension("csv");
            ...
            .And.AtUri(datafileResource + "/RunStormScript?SeaDataFileID={seaDataFileId}&AirDataFileID={airDataFileId}&Hertz={hertz}&DaylightSavings={daylightSavings}&Username={username}").Named("RunStormDataFileScript")
            .And.AtUri(datafileResource + "/RunAirScript?AirDataFileID={airDataFileId}&DaylightSavings={daylightSavings}&Username={username}").Named("RunAirDataFileScript")
        ...
        private void AddFILE_Resources()
        {
           ...
           .And.AtUri(fileResource + "/RunChopperScript?DaylightSavings={daylightSavings}").Named("RunChopperScript")
           .HandledBy<FileHandler>()
           .TranscodedBy<UTF8EntityXmlSerializerCodec>(null).ForMediaType("application/xml;q=1").ForExtension("xml")
        ...
        {            
            ...
            ResourceSpace.Has.ResourcesOfType<List<site>>()
           .AtUri(@"/Sites/FilteredSites?Event={eventId}&State={stateNames}&SensorType={sensorTypeId}&NetworkName={networkNameId}&OPDefined={opDefined}&HWMOnly={hwmOnlySites}&HWMSurveyed={surveyedHWMs}
