...
namespace STNDB.Test
{
    ...
    {
        private string connectionString = "metadata=res://*/STNEntities.csdl|res://*/STNEntities.ssdl|res://*/STNEntities.msl;provider=Npgsql;provider connection string=';Database=stn;Host=stntest.ck2zppz9pgsw.us-east-1.rds.amazonaws.com;Username=fradmin;PASSWORD={0};Application Name=STN';";
